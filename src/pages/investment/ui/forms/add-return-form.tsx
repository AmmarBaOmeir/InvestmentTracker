...
export function AddReturnForm({ isOpen, onClose }: AddReturnModalProps) {
  ...
  return (
    <Modal
      ...
      footer={
        <>
          ...
          <Button type="submit" variant="primary" form="add-return-form">
            {t("common.save")}
          </Button>
        </>
      }
    >
      <p className={styles.description}>
        {t(
          "investment.add_return_desc",
          "Please fill in the details below to add a new return.",
        )}
      </p>
      <form
        id="add-return-form"
